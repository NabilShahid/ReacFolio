jQuery(document).ready(function($){
    ...
    function unbindScroll(section, time) {
    	...
    	if( hijacking == 'off') {
    		$(window).off('scroll', scrollAnimation);
    		( animationType == 'catch') ? $('#mainScrollerDiv, html').scrollTop(section.offset().top) : section.velocity("scroll", { duration: time });
    	}
    }
	...
	function deviceType() {
		...
		return window.getComputedStyle(document.querySelector('#mainScrollerDiv'), '::before').getPropertyValue('content').replace(/"/g, "").replace(/'/g, "");
	}
